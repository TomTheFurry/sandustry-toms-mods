...
exports.LibLoaderEvents = {
    ...
    modInit: function (libloader) {
        var amtStr = JSON.stringify(amount);
        libloader.AddPatches([
            {
                "type": "replace",
                "from": "||!eh(r,i.x,i.y,n.Spore)||",
                "to":`||!(Math.random()>${amtStr}||eh(r,i.x,i.y,n.Spore))||`,
                //"expectedMatches": 1 // Optional
            }
        ]);
        
        libloader.AddPatches([ // Note: This one is the actual one that is needed. Above is just for consistency
            {
                "type": "replace",
                "from": "||!h(e,t.x,t.y,n.RJ.Spore)||",
                "to": `||!(Math.random()>${amtStr}||h(e,t.x,t.y,n.RJ.Spore))||`,
                "expectedMatches": 1
            }
        ], "515");
    }
